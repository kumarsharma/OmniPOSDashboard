...
+ (id)fromXMLFileURL:(NSURL *)fileUrl mappings:(NSDictionary*)inMappings dataTypes:(NSDictionary*)inDataTypes classMappings:(NSDictionary *)inClassMappings;

+ (id)fromXMLData:(NSData *)data mappings:(NSDictionary*)inMappings dataTypes:(NSDictionary*)inDataTypes classMappings:(NSDictionary *)inClassMappings managedObjectContext:(NSManagedObjectContext *)context;
